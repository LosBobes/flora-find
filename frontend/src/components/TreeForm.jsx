        ...
        <div className={labelText}>
          ...
          {existingPhotos.length < MAX_PHOTOS && (
            <input
              ...
              className="sd-file mt-2 block w-full text-sm text-forest-600 file:mr-3 file:rounded-lg file:border-0 file:bg-forest-100 file:px-3 file:py-1.5 file:text-sm file:font-semibold file:text-forest-700"
            />
          )}
          {photos.length > 0 && (
